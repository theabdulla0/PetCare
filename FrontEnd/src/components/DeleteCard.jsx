...
const DeleteCard = ({ isOpen, title, message, onCancel, onConfirm }) => {
  if (!isOpen) return null; // don’t render if not open

  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div className="group select-none w-[320px] flex flex-col p-4 relative items-center justify-center bg-gray-800 border border-gray-700 shadow-lg rounded-2xl">
